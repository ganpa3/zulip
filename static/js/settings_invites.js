...
function do_revoke_invite() {
    const modal_invite_id = $("#confirm-dialog-yes-button").attr("data-invite-id");
    const modal_is_multiuse = $("#confirm-dialog-yes-button").attr("data-is-multiuse");
...
export function on_load_success(invites_data, initialize_event_handlers) {
    ...
    $(".admin_invites_table").on("click", ".revoke", (e) => {
        ...
        confirm_dialog.launch({
            ...
            html_body,
            html_yes_button: $t_html({defaultMessage: "Revoke"}),
            on_click: do_revoke_invite,
        });

        $("#confirm-dialog-yes-button").attr("data-invite-id", meta.invite_id);
        $("#confirm-dialog-yes-button").attr("data-is-multiuse", meta.is_multiuse);
    });
    ...
    $(".admin_invites_table").on("click", ".resend", (e) => {
        ...
        confirm_dialog.launch({
            ...
            html_body,
            html_yes_button: $t_html({defaultMessage: "Resend"}),

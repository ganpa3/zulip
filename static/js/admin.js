...
export function build_page() {
    const options = {
        ...
        realm_create_private_stream_policy: page_params.realm_create_private_stream_policy,
        realm_create_public_stream_policy: page_params.realm_create_public_stream_policy,
